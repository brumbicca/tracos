...
/// <summary>Configurações de Cozinhas Cava — paridade Promob Configurador de Dimensões.</summary>
public sealed class CozinhaCavaSettings
{
    ...
    public CozinhaCavaSettings Clone() => new()
    {
